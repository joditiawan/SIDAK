...
<div class="row">
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-info">
			...
			<a href="index.php?page=data-pend-kaur" class="small-box-footer">Selengkapnya
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-success">
			...
			<a href="index.php?page=data-kartu-kaur" class="small-box-footer">Selengkapnya
				<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-info">
			...
			<a href="index.php?page=data-lahir-kaur" class="small-box-footer">Selengkapnya
				<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-success">
			...
			<a href="index.php?page=data-mendu-kaur" class="small-box-footer">Selengkapnya
				<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-red">
			...
			<a href="index.php?page=data-datang-kaur" class="small-box-footer">Selengkapnya
				<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-warning">
			...
			<a href="index.php?page=data-pindah-kaur" class="small-box-footer">Selengkapnya
				<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>
