...
<head>
<title>CETAK SURAT MENINGGAL</title>
<style> 
...
<center>
        <h4>
            <u><b>DATA MENINGGAL DESA PEKAUMAN TIMUR</b></u>
        </h4>
        <P>No Surat: ... /Ket.Data Meninggal/
    ...
    <table id="example1" class="table table-bordered">
				...
				<tbody>
					...
					<?php
              $no = 1;
			  $sql = $koneksi->query("SELECT p.id_pend, p.nik, p.nama, p.desa, p.rt, p.rw, m.tgl_mendu, m.sebab, m.id_mendu from 
