...
<head>
	...
	<title>Pendataan Dan Pelayanan Masyarakat Pekauman Timur</title>
	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<font color="white">
							<b>APLIKASI PENDATAAN DAN PELAYANAN MASYARAKAT</b>
						</font>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="build/img/KAB_BANJAR.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text">PEKAUMAN TIMUR</span>
			</a>
        ...
        ?>
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="?page=data-pend-kaur" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Penduduk</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=data-kartu-kaur" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Kartu Keluarga</p>
									</a>
								</li>
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="?page=data-lahir-kaur" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Lahir</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=data-mendu-kaur" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Meninggal</p>
									</a>
								</li>
								...
								<li class="nav-item">
									<a href="?page=data-datang-kaur" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Pendatang</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=data-pindah-kaur" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Pindah</p>
									</a>
								</li>
          ...
          switch ($hal) {
              //ADMINISTRATOR
				...
				case 'add-kartu':
					...
					break;
					case 'cetak-tbl-kk':
						include "report/cetak_tbl_kk.php";
						break;
				case 'edit-kartu':
				...
				case 'add-pend':
					...
					break;
					case 'cetak-tbl-penduduk':
						include "report/cetak_tbl_penduduk.php";
						break;
				case 'edit-pend':
				...
				case 'add-lahir':
					...
					break;
					case 'cetak-tbl-lahir':
						include "report/cetak_tbl_lahir.php";
						break;
				case 'edit-lahir':
				...
				case 'add-mendu':
					...
					break;
					case 'cetak-tbl-meninggal':
						include "report/cetak_tbl_meninggal.php";
						break;
				case 'edit-mendu':
				...
				case 'add-pindah':
					...
					break;
					case 'cetak-tbl-pindah':
						include "report/cetak_tbl_pindah.php";
						break;
				case 'edit-pindah':
				...
				case 'add-datang':
					...
					break;
					case 'cetak-tbl-datang':
						include "report/cetak_tbl_datang.php";
						break;
				case 'edit-datang':
			...
			//KAUR PEMERINTAH
			//kartu KK
			case 'data-kartu-kaur':
				include "kaur/kartu/data_kartu.php";
				break;
			case 'anggota-kaur':
				include "kaur/kartu/anggota.php";
				break;

			//penduduk
			case 'data-pend-kaur':
				include "kaur/pend/data_pend.php";
				break;
				case 'view-pend-kaur':
					include "kaur/pend/view_pend.php";
					break;

			//lahir
			case 'data-lahir-kaur':
				include "kaur/lahir/data_lahir.php";
				break;

			//mendu
			case 'data-mendu-kaur':
				include "kaur/mendu/data_mendu.php";
				break;

			//pindah
			case 'data-pindah-kaur':
				include "kaur/pindah/data_pindah.php";
				break;

			//datang
			case 'data-datang-kaur':
				include "kaur/datang/data_datang.php";
				break;
