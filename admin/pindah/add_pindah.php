	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="pindah_ke" name="pindah_ke" placeholder="Tujuan Pindah" required>
				</div>
			</div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO tb_pindah (id_pdd, tgl_pindah, alasan, pindah_ke) VALUES (
			'".$_POST['id_pdd']."',
            '".$_POST['tgl_pindah']."',
			'".$_POST['alasan']."',
            '".$_POST['pindah_ke']."')";
