<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT p.nama, d.id_pindah, d.tgl_pindah, d.alasan, d.pindah_ke FROM 
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="pindah_ke" name="pindah_ke" value="<?php echo $data_cek['pindah_ke']; ?>"
					 required>
				</div>
			</div>
